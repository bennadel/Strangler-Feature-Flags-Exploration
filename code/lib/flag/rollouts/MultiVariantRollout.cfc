component
	...
	*/
	public void function init( required array distribution ) {

		variables.distribution = arguments.distribution;
	...
	*/
	...
	/**
	* I flesh-out the index of variant references using the given distribution. The index
